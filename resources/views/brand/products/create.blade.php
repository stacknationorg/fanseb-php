...
<div class=card-body">
    <div>&nbsp;</div>
        ...
        <form method="POST" action="{{ route('brand.products.create') }}" onsubmit="checkImages(event)" class="col-md-10 p-0 mx-auto" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input id="availability" value="" type="text" class="form-control" name="availability">
            </div>
