          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                ...
                <button class="btn btn-primary btn-sm ms-auto">View Profile</button>
              </div>
            </div>    
<div class=card-body">
    
        <form method="POST" action="{{ route('creator.profile') }}" class="col-md-10 p-0 mx-auto" enctype="multipart/form-data">
