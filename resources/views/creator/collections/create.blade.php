...
<div class=card-body">
    <div>&nbsp;</div>
        ...
        <form method="POST" action="{{ route('creator.collections.create') }}" class="col-md-10 p-0 mx-auto" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="form-label" for="thumbnail">Collection Thumbnail:</label>
